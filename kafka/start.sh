...
KAFKA_EXT_PORT=${KAFKA_EXT_PORT:-"31092"}
KAFKA_EXT_HOST_NAME=${KAFKA_EXT_HOST_NAME:-"192.168.99.100"}
export KAFKA_LISTEN_PORT ZOOKEEPER_CONNECTION_STRING KAFKA_ADVERTISED_PORT KAFKA_EXT_PORT KAFKA_EXT_HOST_NAME
